...
const excludeFields = require('../src/excludeFields');
...
module.exports.tests.exclude = function(test, common) {
  ...
  test('top level and nested fields are removed', function(t) {
    ...
    const result = excludeFields(['popularity', 'parent.county_a', 'not_present'])(doc);
  ...
  test('original document is not modified', function(t) {
    ...
    excludeFields(['popularity', 'parent.county_a'])(doc);
...
module.exports.all = function (tape, common) {
  ...
  function test(name, testFunction) {
    return tape('excludeFields: ' + name, testFunction);
  }
